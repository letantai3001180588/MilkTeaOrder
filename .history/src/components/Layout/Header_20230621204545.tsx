    ...
    <Fragment>
      <header className={classes.header}>
        <div style={{display:'flex'}}>
          <img src="https://png.pngtree.com/png-clipart/20200701/original/pngtree-cartoon-hand-drawn-pearl-milk-tea-png-image_5409549.jpg" style={{width:50,height:50,margin:'auto'}}/>
          <h1>Trà Sữa</h1>
        </div>
