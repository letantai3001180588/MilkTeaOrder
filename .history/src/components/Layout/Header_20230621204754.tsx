    ...
    <Fragment>
      <header className={classes.header}>
        <div style={{display:'flex'}}>
          <img src="https://png.pngtree.com/png-vector/20201224/ourmid/pngtree-cartoon-hand-drawn-black-sugar-pearl-milk-tea-vector-illustration-material-png-image_2604089.jpg" style={{width:50,height:50,margin:'auto'}}/>
          <h1>Trà Sữa</h1>
        </div>
