    ...
    <Fragment>
      <header className={classes.header}>
        <div style={{display:'flex'}}>
          <img src="https://png.pngtree.com/png-clipart/20230122/original/pngtree-milk-tea-boba-icon-or-logo-png-image_8927032.png" style={{width:50,height:50,margin:'auto'}}/>
          <h1>Trà Sữa</h1>
        </div>
